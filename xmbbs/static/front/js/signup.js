...
//         var sign = md5(timestamp+telephone+"qkasdfwermnkskjak%#$@");
//         zlajax.post({
//             'url': '/c/sms_captcha/',
//             'data':{
//                 'telephone': telephone,
